...
<script type="text/javascript">
	...
	function get_data() {
		data = { app:'book',method:'calculate_price','lang':'{$lang}', date_from:$('#date_from').val(),date_to:$('#date_to').val(),transfer:get_checkbox('#transfer'),breakfast:get_checkbox('#breakfast'),rooms: { }, coupon: $('#coupon').val() };
