		...
		public function __construct() {
			parent::__construct('coupon');
                ...
                public function coupon_create($form_data) {
                    dibi::query("insert into book_coupons (valid_from, valid_to, code, value) values (%t, %t, %s, %i)",
                            strtotime($form_data["valid_from"]), strtotime($form_data["valid_to"]), $form_data["code"], $form_data["value"]);
